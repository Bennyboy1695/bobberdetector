...
public class BobberPonder {
    ...
    public static void bobberBasic(SceneBuilder sceneBuilder, SceneBuildingUtil util) {
        ...
        scene.effects().emitParticles(bobberParticles, scene.effects().simpleParticleEmitter(ParticleTypes.BUBBLE, Vec3.ZERO), .2f,390 );
        scene.effects().emitParticles(bobberParticles, scene.effects().simpleParticleEmitter(ParticleTypes.SPLASH, Vec3.ZERO),.3f,390 );
        ...
        scene.effects().emitParticles(bobberParticles, scene.effects().simpleParticleEmitter(ParticleTypes.SPLASH, Vec3.ZERO),1.2f,20 );
        scene.effects().emitParticles(bobberParticles, scene.effects().particleEmitterWithinBlockSpace(ParticleTypes.SPLASH, Vec3.ZERO),.2f,20 );
        scene.effects().emitParticles(bobberParticles, scene.effects().particleEmitterWithinBlockSpace(ParticleTypes.BUBBLE, Vec3.ZERO),.2f,20 );
